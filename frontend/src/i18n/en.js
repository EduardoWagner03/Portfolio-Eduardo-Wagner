...
const en = {
  ...
  projects: {
    ...
    items: {
      ...
      flowtime: {
        title: "FlowTime",
        subtitle: "Completed and in Operation",
        description:
          "A complete web management system, built specifically for one podiatry clinic, bringing efficiency, organization and convenience to its daily operations. It is completed and has been in operation since delivery, and is now being expanded into a SaaS.",
        story:
          "FlowTime started in October 2024 and was completed in January 2025, built by a team of 3. It was also my own final thesis project, defended individually at UGV and awarded the top grade of 10, and delivered for commercial use. At the time of the defense the system served one specific clinic and was not a SaaS: growing it into a multi-client product was precisely the future direction I presented. That direction is now underway: the system remains completed and in operation at the clinic, while being expanded into a SaaS in parallel. The system came from a real need to digitize and automate that clinic's workflow. It offers an interactive dashboard, PDF reports, digital signatures and advanced features to manage appointments, patients and revenue. With a modern interface and robust functionality, FlowTime brought more agility, security and quality to patient care, and was successfully deployed in a real production environment.",
  ...
  experience: {
    ...
    items: {
      ...
      flowtime: {
        ...
        bullets: [
          "Management system tailored to a single podiatry clinic",
