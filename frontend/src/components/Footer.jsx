        ...
        <div className="footer-content-minimal">
          <div className="row align-items-center justify-content-between flex-nowrap">
            <div className="col-auto d-flex align-items-center gap-3">
              <img src="/images/img.jpeg" alt={t("footerName")} className="footer-avatar"
                style={{ width: "40px", height: "40px", borderRadius: "50%", objectFit: "cover", border: "2px solid #fff", boxShadow: "0 2px 12px rgba(30,136,229,0.10)", }} />
              <span
            ...
            <div className="col text-center d-none d-md-block">
              <span className="footer-role"
                style={{ color: "#b3d8f7", fontSize: "0.95rem", fontWeight: 500, }} >
                {t("footerRole")}
              </span>
